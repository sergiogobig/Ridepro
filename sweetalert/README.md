...
[See it in action!](https://t4t5.github.io/sweetalert)
...
[View more examples](https://t4t5.github.io/sweetalert)
...
- Make sure you have [Node](https://nodejs.org/), [NPM](https://www.npmjs.com/) and [Gulp](https://gulpjs.com/) installed. When in the SweetAlert directory, run `npm install` to install the dependencies. Then run `gulp` while working to automatically minify the SCSS and JS-files.
